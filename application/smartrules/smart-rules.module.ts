...
angular.module("c8y.smartRulesUI", ["c8y.smartRules"])
    .config(["c8yViewsProvider", "gettext", function(c8yViewsProvider, gettext) {
        [
            "application/:applicationId/tabgroup/:tabGroup/dashboard/:frameworkDashboardId/device/:deviceId/smartrules",
            "application/:applicationId/dashboard/:frameworkDashboardId/device/:deviceId/smartrules"
        ].forEach(urlPattern => {
