...
* **Seamless upgrade experience:** We are getting ready for next major version and application builder 1.3.2 will provide seamless upgrade experience for upcoming major version.
* **Various bug fixes**
